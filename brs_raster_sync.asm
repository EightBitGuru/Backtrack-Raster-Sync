...
timer_init: stx brs_runtime_memory.Backtrack_Video_Flag           	// [3]		stash PAL/NTSC flag bit in ZP
...
timer_copy:	lda brs_static_data.Backtrack_Timer_Values,y	        // [4]		get cycle timer byte
			...
			asl brs_runtime_memory.Backtrack_Video_Flag  	        // [3]		get PAL/NTSC flag bit to Carry
            bcc set_count                                           // [2/3]    set PAL count
            ldy #140                                                // [2]      NTSC inner count
set_count:	sty brs_runtime_memory.Backtrack_Loop_Counter           // [4]		stash inner loop count
...
sw_outer:   ldy brs_runtime_memory.Backtrack_Loop_Counter           // [2]   PAL inner count (NTSC: #674)
sw_inner:   dey                                                     // [2]
            bne sw_inner                                            // [3/2]
...
.pc = * "Backtrack IRQ"
{
            inc vic20.vic.VCSCRNCO                                // [x]      get screen colour 
