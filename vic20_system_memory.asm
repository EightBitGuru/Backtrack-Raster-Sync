...
.namespace via1
{
    ...
    .label V1T1CL	= $9114			//	timer #1 low byte counter
    .label V1T1CH	= $9115			//	timer #1 high byte counter
    .label V1T1LL	= $9116			//	timer #1 low byte latch
    .label V1T1LH	= $9117			//	timer #1 high byte latch
    .label V1T2CL	= $9118			//	timer #2 low byte counter
    .label V1T2CH	= $9119			//	timer #2 high byte counter
...
.namespace via2
{
    ...
    .label V2T1CL	= $9124			//	timer #1 low byte counter
    .label V2T1CH	= $9125			//	timer #1 high byte counter
    .label V2T1LL	= $9126			//	timer #1 low byte latch
    .label V2T1LH	= $9127			//	timer #1 high byte latch
    .label V2T2CL	= $9128			//	timer #2 low byte counter
    .label V2T2CH	= $9129			//	timer #2 high byte counter
...
.namespace kernal
{
    ...
    .label DECODE2	= $EC0F			//	Entry after SHIFT/C= logic
